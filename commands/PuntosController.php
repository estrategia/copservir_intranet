...
class PuntosController extends Controller
{
  public function actionSincronizar()
  {
    ...
    $client = new Client();
    $urlPuntosSiicop = "http://localhost/copservir/formacionComunicaciones/puntos/sincronizar?idSincronizado={$idSincronizado}";
    ...
    $columnas = ['numeroDocumento', 'valorPuntos', 'descripcionPunto', 'idPuntoSincronizado'];
    $filas = [];
