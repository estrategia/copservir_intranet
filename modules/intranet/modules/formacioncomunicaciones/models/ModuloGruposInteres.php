 ...
 *
 */
class ModuloGruposInteres extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 't_FORCO_ModuloGruposInteres';
    }
    ...
    {
        return [
            [['idGrupoInteres', 'idModulo'], 'required'],
            [['idGrupoInteres', 'idModulo'], 'integer'],
