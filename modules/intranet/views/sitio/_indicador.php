<?php if(!in_array("3_$indicador->idIndicador",Yii::$app->user->identity->getOcultosDashboard())): ?>
    ...
    <div class="tiles <?= $indicador->colorFondo ?>    m-b-10">
        <div class="tiles-body">
            <div class="controller">
                ...
                <a href="javascript:;" data-role="quitar-elemento" data-elemento="3_<?= $indicador->idIndicador ?>" class="remove"></a>
            </div>
