...
<div class="col-md-12">
  <h3>Iconos</h3>
  <div class="bs-glyphicons" style="    margin: 0 -10px 20px;overflow: hidden;">
    <ul class="bs-glyphicons-list" style="margin-top: 0;margin-bottom: 10px;">
      <li>
      ...
      <li>
        ...
        <span cass="glyphicon-class">glyphicon glyphicon-collapse-down</span>
      </li>
      <li>
        <span class="glyphicon glyphicon-collapse-up" aria-hidden="true"></span>
        <span cass="glyphicon-class">glyphicon glyphicon-collapse-up</span>
      </li>
      <li>
        <span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>
        <span cass="glyphicon-class">glyphicon glyphicon-log-in</span>
      </li>
      <li>
        <span class="glyphicon glyphicon-flash" aria-hidden="true"></span>
        <span cass="glyphicon-class">glyphicon glyphicon-flash</span>
      </li>
      <li>
