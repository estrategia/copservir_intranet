    ...
    <div class=" tiles white col-md-12 no-padding">
      ...
      <div class="post col-md-12">
        ...
        <div class="info-wrapper">
          ...
          <div class="col-md-2">
            <?= Html::a('Actualizar datos', ['/intranet/site/actualizar-datos'], ['class' => 'btn btn-primary btn-small', 'name' => 'forgot-button']) ?>
            <?= Html::a('Cambiar contraseña', ['/intranet/site/cambiar-clave'], ['class' => 'btn btn-primary btn-small', 'name' => 'forgot-button']) ?>
          </div>
