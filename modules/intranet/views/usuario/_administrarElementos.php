...
<div class="row">
    <div class="col-md-4">
        <div class="buton-check">
            ...
            <div class="text-center"><input id="baner-inicio" type='checkbox' data-role="toggle-elemento" data-elemento="<?= \app\modules\intranet\models\UsuarioWidgetInactivo::WIDGET_BANNER_SUP ?>" <?= !in_array(\app\modules\intranet\models\UsuarioWidgetInactivo::WIDGET_BANNER_SUP, $opciones) ? 'checked' : '' ?> />
            <label for="baner-inicio"><span><span></span></span> Banner Inicio </label></div>
        </div>
    </div>
