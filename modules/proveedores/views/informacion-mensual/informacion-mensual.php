...
<h1>Inventario Rotación Mensual</h1>
	<object width="100%" height="1200px" data="http://intranet2.copservir.com/proveedores/docs/entrega_informacion_mensual_multiportal.php?id=<?=$id?>&cod_prov=<?=$cod_prov?>&name_prov=<?=$name_prov?>"></object>
</div>